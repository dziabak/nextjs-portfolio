...
export const metadata: Metadata = {
	title: "Software | GD",
	description: "Frontend and software page of portfolio page",
};
	...
	return (
		<section id="hero">
			...
			<div className="space-y-2 text-lg mb-8">
				<p>
					I am a versatile professional with a strong foundation in UI and UX in
					video games, quality assurance and frontend development.
				</p>
				<p>
					Drawing on over seven years of experience in creating engaging systems
					and intuitive UI for games, I bring a unique perspective to crafting
				...
				<p>
					I am also skilled at software testing and writing automated tests in{" "}
					<span className="font-bold">Cypress</span> and{" "}
					<span className="font-bold">Playwright</span> as well as familiar with{" "}
